<%@include file="../login/header.jsp" %>
 <center><h3><label><u>ApplicationRoles</u></label></h3></center>
<form method='POST'> 
<div class="row">
<div class='col-lg-3 col-sm-3 col-md-3 col-xs-6'>
<label>Roles Id</label>
<input type='text' name='rolesId' id='rolesId'  class='form-control'/>
</div>
<div class='col-lg-3 col-sm-3 col-md-3 col-xs-6'>
...
function edit(sn){
var id = ['rolesId','description','displayName','name'];
...
<%--
return "\n{\"rolesId\": \""+rolesId+"\",\"description\": \""+description+"\",\"displayName\": \""+displayName+"\",\"name\": \""+name+"\"}";
--%>