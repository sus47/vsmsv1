<%@include file="../login/header.jsp" %>
 <center><h3><label><u>ResultDivPara</u></label></h3></center>
<form method='POST'> 
<div class="row">
...
<input type='text' name='divisionName' id='divisionName'  class='form-control'/>
</div>
<div class='col-lg-3 col-sm-3 col-md-3 col-xs-6'>
...
function edit(sn){
var id = ['id','precentFrom','precentTo','divisionName'];
...
<%--
return "\n{\"id\": \""+id+"\",\"precentFrom\": \""+precentFrom+"\",\"precentTo\": \""+precentTo+"\",\"divisionName\": \""+divisionName+"\"}";
--%>