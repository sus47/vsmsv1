<%@include file="../login/header.jsp" %>
 <center><h3><label><u>StudentPhotoDetails</u></label></h3></center>
<form method='POST'> 
<div class="row">
...
<input type='text' name='photoLink' id='photoLink'  class='form-control'/>
</div>
<div class='col-lg-3 col-sm-3 col-md-3 col-xs-6'>
...
<%--
return "\n{\"sn\": \""+sn+"\",\"studentSn\": \""+studentSn+"\",\"photoLink\": \""+photoLink+"\"}";
--%>